...
def reset_timer():
    ...
    my_label_1.config(text="Timer", fg=GREEN)
    my_label_2["text"] = ""
    global reps
    reps = 0
...
def count_down(count):
    ...
    count_sec = count % 60
    #changing a variable's data type by changing its content is called dynamic typing
    if count_sec < 10:
...
my_label_1 = Label(text="Timer", font=(FONT_NAME, 50), fg=GREEN, bg=YELLOW)
my_label_1.grid(column=1, row=0)

my_label_2 = Label(font=(FONT_NAME, 20, "bold"), fg=GREEN, bg=YELLOW)
